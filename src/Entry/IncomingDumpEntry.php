...
/**
 * Class IncomingDumpEntry
 * @package Isotopes\Profiler\Entry
 */
class IncomingDumpEntry extends IncomingEntry
{
    ...
    {
        $entryPoint = collect($batch)->first(static function ($entry) {
            return in_array($entry->type, [EntryType::REQUEST, EntryType::JOB, EntryType::COMMAND], true);
        });
     ...
     *
     * @param IncomingEntry $entryPoint
     * @return mixed|string
     */

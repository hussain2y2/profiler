...
<head>
    ...
    <link rel="shortcut icon" href="{{ asset('/vendor/profiler/favicon.ico') }}">
    <meta name="robots" content="noindex, nofollow">
    <title>Profiler {{ config('app.name') ? ' - ' . config('app.name') : '' }}</title>
    <link href="https://fonts.googleapis.com/css?family=Nunito" rel="stylesheet">
    <link href="{{ asset(mix($cssFile, 'vendor/profiler')) }}" rel="stylesheet" type="text/css">
</head>
<body>
<div id="profiler" v-cloak>
    ...
    <div class="container mb-5">
        <div class="d-flex align-items-center py-4 header">
            ...
            <h4 class="mb-0 ml-3"><strong>Laravel</strong> Profiler{{ config('app.name') ? ' - ' . config('app.name') : '' }}</h4>
            ...
            <div class="col-10">
                @if (! $assetsAreCurrent)
                    <div class="alert alert-warning">
                        The published Profiler assets are not up-to-date with the installed version. To update, run:<br/><code>php artisan profiler:publish</code>
                    </div>
                @endif
...
<script>
    window.Profiler = @json($profilerScriptVariables);
</script>
<script src="{{ asset(mix('app.js', 'vendor/profiler')) }}"></script>
</body>
</html>
